...
namespace newone {
	...
	/// </summary>
	public ref class Retailer1 : public System::Windows::Forms::Form
	{
	public:
		Retailer1(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->PricePerUnit = (gcnew System::Windows::Forms::NumericUpDown());
			...
			this->Review = (gcnew System::Windows::Forms::DataGridViewTextBoxColumn());
			this->Acceptance = (gcnew System::Windows::Forms::DataGridViewTextBoxColumn());
			...
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->PricePerUnit))->BeginInit();
			...
			this->Panel_Main->Selected += gcnew System::Windows::Forms::TabControlEventHandler(this, &Retailer1::Panel_Main_Selected);
			// 
			// tabPage1
			// 
			...
			this->tabPage1->Text = L"Place Order";
			...
			this->Items->Size = System::Drawing::Size(276, 301);
			this->Items->TabIndex = 0;
			this->Items->SelectedIndexChanged += gcnew System::EventHandler(this, &Retailer1::listBox1_SelectedIndexChanged);
			// 
			// splitContainer3
			// 
			...
			this->splitContainer3->Size = System::Drawing::Size(276, 101);
			this->splitContainer3->SplitterDistance = 32;
			this->splitContainer3->TabIndex = 0;
			this->splitContainer3->SplitterMoved += gcnew System::Windows::Forms::SplitterEventHandler(this, &Retailer1::splitContainer3_SplitterMoved);
			// 
			// button1
			// 
			...
			this->button1->Size = System::Drawing::Size(276, 32);
			this->button1->TabIndex = 0;
			this->button1->Text = L"Add Item";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &Retailer1::button1_Click);
			// 
			// splitContainer10
			// 
			...
			this->splitContainer10->Size = System::Drawing::Size(276, 65);
			...
			// 
			this->splitContainer11->Panel2->Controls->Add(this->label5);
			this->splitContainer11->Size = System::Drawing::Size(134, 65);
			...
			this->label4->Location = System::Drawing::Point(50, 9);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(65, 13);
			this->label4->TabIndex = 0;
			this->label4->Text = L"Set Quantity";
			// 
			// label5
			// 
			...
			this->label5->Text = L"Set Price";
			// 
			// splitContainer12
			// 
			this->splitContainer12->Dock = System::Windows::Forms::DockStyle::Fill;
			this->splitContainer12->Location = System::Drawing::Point(0, 0);
			...
			// 
			this->splitContainer12->Panel1->Controls->Add(this->Quantity_Meter);
			// 
			// splitContainer12.Panel2
			// 
			this->splitContainer12->Panel2->Controls->Add(this->PricePerUnit);
			this->splitContainer12->Size = System::Drawing::Size(138, 65);
			this->splitContainer12->SplitterDistance = 33;
			...
			this->Quantity_Meter->Size = System::Drawing::Size(138, 20);
			this->Quantity_Meter->TabIndex = 0;
			// 
			// PricePerUnit
			// 
			this->PricePerUnit->Dock = System::Windows::Forms::DockStyle::Fill;
			this->PricePerUnit->Location = System::Drawing::Point(0, 0);
			this->PricePerUnit->Name = L"PricePerUnit";
			this->PricePerUnit->Size = System::Drawing::Size(138, 20);
			this->PricePerUnit->TabIndex = 1;
			// 
			// splitContainer4
			// 
			...
			this->Place_Order->Click += gcnew System::EventHandler(this, &Retailer1::button2_Click);
			// 
			// splitContainer6
			// 
			...
			this->Remove_item->Click += gcnew System::EventHandler(this, &Retailer1::Remove_item_Click);
			// 
			// dataGridView1
			// 
			...
			this->splitContainer7->Panel1->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &Retailer1::splitContainer7_Panel1_Paint);
			// 
			...
			// 
			this->splitContainer9->Panel1->Controls->Add(this->Bills);
			this->splitContainer9->Size = System::Drawing::Size(222, 406);
			...
			this->Bills->Size = System::Drawing::Size(222, 319);
			this->Bills->TabIndex = 0;
			this->Bills->SelectedIndexChanged += gcnew System::EventHandler(this, &Retailer1::Bills_SelectedIndexChanged);
			// 
			// splitContainer8
			// 
			...
			this->Total_Table->Columns->AddRange(gcnew cli::array< System::Windows::Forms::DataGridViewColumn^  >(4) {this->Bill_Total_Items, 
				this->Bill_Total_Price, this->Review, this->Acceptance});
			...
			this->Total_Table->CellContentClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &Retailer1::Total_Table_CellContentClick);
			// 
			// Bill_Total_Items
			// 
			...
			// Review
			// 
			this->Review->HeaderText = L"Review";
			this->Review->Name = L"Review";
			// 
			// Acceptance
			// 
			this->Acceptance->HeaderText = L"Accepted / Rejected";
			this->Acceptance->Name = L"Acceptance";
			// 
			// tabPage3
			// 
			...
			this->logout->Click += gcnew System::EventHandler(this, &Retailer1::logout_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &Retailer1::button2_Click_1);
			// 
			// Retailer1
			// 
			...
			this->Name = L"Retailer1";
			this->Text = L"Retailer";
			this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &Retailer1::Customer_FormClosing);
			this->FormClosed += gcnew System::Windows::Forms::FormClosedEventHandler(this, &Retailer1::Customer_FormClosed);
			this->Load += gcnew System::EventHandler(this, &Retailer1::Customer_Load);
			...
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->PricePerUnit))->EndInit();
...
#pragma endregion
	...
	private: System::Void Customer_Load(System::Object^  sender, System::EventArgs^  e) {
				 dat = gcnew database;
				 this->Panel_Main->SelectedIndex = 0;
				 data= this->dat->item_list();
				 while(data->Read())
				 {
					 this->Items->Items->Add(data[1]);
				 }
				 ...
				 if(this->Items->SelectedIndex != -1)
				 {
					 ...
					 for(i=0;i<this->Table1->Rows->Count-1;i++)
					 {
						 ...
						 {					 					 
							 ...
							 row->Cells["Price_per_Unit"]->Value = this->PricePerUnit->Value;
							 while(data->Read())
							 {
								 row->Cells["Total_Value"]->Value = (this->PricePerUnit->Value * this->Quantity_Meter->Value);
							 }
							 flag=false;
						 }
					 }
	...
	private: System::Void Bills_SelectedIndexChanged(System::Object^  sender, System::EventArgs^  e) {
				 if(this->Bills->SelectedIndex != -1)
				 {
					 ...
					 dat= gcnew database;
					 data = dat->retailer_bill_status(System::Convert::ToInt32(bill_Id[2]));
					 String^ st1="";
					 String^ st2="";
					 while(data->Read())
					 {
						 st1 = data->GetString("reviewed");
						 if(st1=="no")
							 st2="-";
						 else
							 st2=data->GetString("status");
					 }
					 //dat->conn->Close();
					 dat= gcnew database;
					 ...
					 row->Cells["Review"]->Value = st1;
					 row->Cells["Acceptance"]->Value = st2;
	...
	private: System::Void splitContainer7_Panel1_Paint(System::Object^  sender, System::Windows::Forms::PaintEventArgs^  e) {
			 }
private: System::Void Total_Table_CellContentClick(System::Object^  sender, System::Windows::Forms::DataGridViewCellEventArgs^  e) {
		 }
private: System::Void splitContainer3_SplitterMoved(System::Object^  sender, System::Windows::Forms::SplitterEventArgs^  e) {
		 }
};
}
